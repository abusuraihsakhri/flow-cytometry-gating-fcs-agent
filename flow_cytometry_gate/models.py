"""
Data Models & Telemetry Definitions for FlowGate-AI: FCS 3.1 Flow Cytometry Compensation & Auto-Gating Agent.
Domain: Immunology
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "ISAC FCS 3.1 / Gating-ML Standards"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
