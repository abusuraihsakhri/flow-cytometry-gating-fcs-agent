"""
Core Algorithmic Engine & Cryptographic / Biological Logic for FlowGate-AI: FCS 3.1 Flow Cytometry Compensation & Auto-Gating Agent.
Domain: Immunology
Standard: ISAC FCS 3.1 / Gating-ML Standards
"""
import math
    ...
    def evaluate_primary_parameter(cls, value: float) -> Optional[Dict[str, Any]]:
        if value > cls.PRIMARY_BOUND:
            return {
                ...
                "details": f"Parameter value ({value:.3f}) exceeds operational threshold ({cls.PRIMARY_BOUND:.1f}) under ISAC FCS 3.1 / Gating-ML Standards.",
    ...
    def audit_specification_conformance(cls, descriptor: str, attributes: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        if any(flag in desc_upper for flag in ["VIOLATION", "DISCORDANT", "ANOMALY", "MUTANT", "LEAK"]):
            return {
                ...
                "details": f"Telemetry status flag '{descriptor}' violates ISAC FCS 3.1 / Gating-ML Standards conformance matrix.",
