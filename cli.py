"""
Command Line Interface for Flow Cytometry Gating Fcs Agent.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="flow-cytometry-gating-fcs-agent", description="Flow Cytometry Gating Fcs Agent")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  FLOW CYTOMETRY GATING FCS AGENT")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Flow Cytometry Gating Fcs Agent Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Flow Cytometry Gating Fcs Agent API server on http://{args.host}:{args.port}")
